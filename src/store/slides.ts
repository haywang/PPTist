...
export const useSlidesStore = defineStore('slides', {
  state: (): SlidesState => ({
    title: 'Untitled Presentation', // 幻灯片标题，未命名演示文稿
    theme: {
    ...
    templates: [
      { name: '红色通用', id: 'template_1', cover: 'https://orcappt.vercel.app/img/template_1.jpg' },
      { name: '蓝色通用', id: 'template_2', cover: 'https://orcappt.vercel.app/img/template_2.jpg' },
      { name: '紫色通用', id: 'template_3', cover: 'https://orcappt.vercel.app/img/template_3.jpg' },
      { name: '莫兰迪配色', id: 'template_4', cover: 'https://orcappt.vercel.app/img/template_4.jpg' },
    ], // 模板
  }),
